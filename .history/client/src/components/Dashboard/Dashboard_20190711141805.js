                                    ...
                                    return <div key={index}>
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                                            ...
                                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-around', marginTop: '15px'}}>
                                                <div>
                                                <span><i className="fa fa-trash-o" style={{ color: 'red', fontSize: '40px', }} onClick={() => this.deleteProduct(product._id)}></i></span>
                                            </div>
                                                <div>
                                                    <button onClick={() => this.addToCartHandler(product)}>Add To Cart</button> 
                                                    </div>
                                            </div>
